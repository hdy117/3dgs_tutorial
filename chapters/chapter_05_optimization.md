...
+--------+--------+------+--------+--------+----------+
| L1     | Σ|Δ|  | ±1   | 鲁棒，不漂移| 可能模糊 | (1-λ)=0.2 |
| L2     | ΣΔ²    | 2·Δ  | 数学简洁 | 敏感离群点| 0        |
...
| scale_threshold| 0.01像素| Densify触发尺度| 高斯太扁→↓阈值    |
